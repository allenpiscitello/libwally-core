...
class wally_psbt_input(Structure):
    _fields_ = [('utxo', POINTER(wally_tx)),
                ...
                ('sequence', c_uint32),
                ('has_sequence', c_uint32),
                ('required_locktime', c_uint32),
                ('required_locktime', c_uint32),
                ('issuance_amount', c_uint64),
                ('has_issuance_amount', c_uint32),
                ('issuance_commitment', c_void_p),
                ('issuance_commitment_len', c_ulong),
                ('issuance_rangeproof', c_void_p),
                ('issuance_rangeproof_len', c_ulong),
                ('issuance_blind_proof', c_void_p),
                ('issuance_blind_proof_len', c_ulong),
                ('issuance_blinding_nonce', c_void_p),
                ('issuance_blinding_nonce_len', c_ulong),
                ('issuance_asset_entropy', c_void_p),
                ('issuance_asset_entropy_len', c_ulong),
                ('inflation_keys_value', c_uint64),
                ('has_inflation_keys_value', c_uint32),
                ('inflation_keys_commitment', c_void_p),
                ('inflation_keys_commitment_len', c_ulong),
                ('inflation_keys_rangeproof', c_void_p),
                ('inflation_keys_rangeproof_len', c_ulong),
                ('issuance_blind_keys_proof', c_void_p),
                ('issuance_blind_keys_proof_len', c_ulong),
...
for f in (
    ...
    ('wally_psbt_input_set_blinding_nonce', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ...
    ('wally_psbt_input_set_inflation_keys_blind_proof', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ('wally_psbt_input_set_inflation_keys_commitment', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ('wally_psbt_input_set_inflation_keys_rangeproof', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ('wally_psbt_input_set_issuance_amount', c_int, [POINTER(wally_psbt_input), c_uint64]),
    ('wally_psbt_input_set_issuance_amount_blind_proof', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ('wally_psbt_input_set_issuance_amount_commitment', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ('wally_psbt_input_set_issuance_amount_rangeproof', c_int, [POINTER(wally_psbt_input), c_void_p, c_ulong]),
    ...
    ('wally_psbt_input_set_sequence', c_int, [POINTER(wally_psbt_input), c_uint]),
    ...
    ('wally_psbt_output_set_script', c_int, [POINTER(wally_psbt_output), c_void_p, c_ulong]),
