...
%apply(char *STRING, size_t LENGTH) { (const unsigned char* blinding_nonce, size_t blinding_nonce_len) };
...
%apply(char *STRING, size_t LENGTH) { (const unsigned char* inflation_keys_blind_proof, size_t inflation_keys_blind_proof_len) };
%apply(char *STRING, size_t LENGTH) { (const unsigned char* inflation_keys_commitment, size_t inflation_keys_commitment_len) };
...
%apply(char *STRING, size_t LENGTH) { (const unsigned char* issuance_amount_blind_proof, size_t issuance_amount_blind_proof_len) };
...
%apply(char *STRING, size_t LENGTH) { (const unsigned char* utxo_rangeproof, size_t utxo_rangeproof_len) };
...
%returns_void__(wally_psbt_clear_input_inflation_keys);
%returns_void__(wally_psbt_clear_input_issuance_amount);
%returns_void__(wally_psbt_clear_input_pegin_amount);
...
%returns_size_t(wally_psbt_get_input_blinding_nonce);
%returns_size_t(wally_psbt_get_input_blinding_nonce_len);
%returns_size_t(wally_psbt_get_input_claim_script);
%returns_size_t(wally_psbt_get_input_claim_script_len);
%returns_size_t(wally_psbt_get_input_entropy);
%returns_size_t(wally_psbt_get_input_entropy_len);
...
%returns_size_t(wally_psbt_get_input_inflation_keys);
%returns_size_t(wally_psbt_get_input_inflation_keys_blind_proof);
%returns_size_t(wally_psbt_get_input_inflation_keys_blind_proof_len);
...
%returns_size_t(wally_psbt_get_input_issuance_amount_blind_proof);
%returns_size_t(wally_psbt_get_input_issuance_amount_blind_proof_len);
...
%returns_size_t(wally_psbt_get_input_pegin_amount);
%returns_struct(wally_psbt_get_input_witness_utxo_alloc, wally_tx_witness_stack);
...
%returns_size_t(wally_psbt_get_scalar_len);
...
%returns_void__(wally_psbt_set_elements_tx_modifiable_flags);
%returns_void__(wally_psbt_set_fallback_locktime);
%returns_void__(wally_psbt_set_global_tx);
%returns_void__(wally_psbt_set_input_blinding_nonce);
%returns_void__(wally_psbt_set_input_claim_script);
%returns_void__(wally_psbt_set_input_entropy);
...
%returns_void__(wally_psbt_set_input_inflation_keys_blind_proof);
...
%returns_void__(wally_psbt_set_input_issuance_amount_blind_proof);
...
%returns_void__(wally_psbt_set_input_pegin_witness);
...
%returns_void__(wally_psbt_set_scalar);
