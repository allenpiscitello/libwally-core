...
%pybuffer_nullable_binary(const unsigned char* inflation_keys_blind_proof, size_t inflation_keys_blind_proof_len);
%pybuffer_nullable_binary(const unsigned char* inflation_keys_commitment, size_t inflation_keys_commitment_len);
...
%pybuffer_nullable_binary(const unsigned char* issuance_amount_blind_proof, size_t issuance_amount_blind_proof_len);
...
%pybuffer_nullable_binary(const unsigned char* previous_txid, size_t previous_txid_len);
